...
export class RegeionListComponent implements OnInit{
 fromHeader: string = 'Area';
  ...
  userColumns = [
    ...
    { caption: 'Division', key: 'divisionName' },
    { caption: 'District', key: 'districtName' },
    { caption: 'Upazila', key: 'upazilaName' },
    { caption: 'Area', key: 'subAreaName' },
  ];
